...
export class PanchangMapService {
  ...
  constructor() { }
   ...
   mapPanchangObj(panchangObject:{ [key: string]: any }): { [key: string]: any }{
    ...
    panchangObject['rashiObj']['sun'].forEach((element: any) => { element['sunRashiMap'] = this.rashi[element['rashi']]; }); 
    panchangObject['masaObj']['amantaMasaMap'] = this.masa[panchangObject['masaObj']['amantaMasa']];
    panchangObject['masaObj']['amantaRituMap'] = this.ritu[panchangObject['masaObj']['amantaRitu']];
    panchangObject['masaObj']['siderealRituMap'] = this.ritu[panchangObject['masaObj']['siderealRitu']];
    panchangObject['masaObj']['ayanaMap'] = this.ayana[panchangObject['masaObj']['ayana']];
    panchangObject['masaObj']['purnimantaMasaMap'] = this.masa[panchangObject['masaObj']['purnimantaMasa']];
    panchangObject['dayDuration']['paharaMap'] = this.pahara[panchangObject['dayDuration']['pahara']];
    panchangObject['calSystemObj']['vikramSamvatSaraMap'] = this.samvatsara[panchangObject['calSystemObj']['vikramSamvatSara']];
    panchangObject['calSystemObj']['sakaSamvatSaraMap'] = this.samvatsara[panchangObject['calSystemObj']['sakaSamvatSara']];
    return panchangObject;
   }
